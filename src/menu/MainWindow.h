...
public:
    ...
    void OpenInputGetterMenu(s32 controller_type);
    void openPageForController(s32 controller_type);
...
private:
    ...
    void OnInputGetterMenuFinish(GuiElement *element, bool result,s32 controller_type);

    void clickListEntryByController(s32 controller_type);
    ...
    CMutex guiMutex;
    InputGetterMenu * getterMenu = NULL;
};
