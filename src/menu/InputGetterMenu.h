...
public:
    InputGetterMenu(s32 controller_type);
    virtual ~InputGetterMenu();

    sigslot::signal3<GuiElement *,bool,s32> inputGetterMenuQuit;
...
private:
    ...
    s32 getControllerType();
    void setControllerType(s32 controller_type);
